...
inline _BidirectionalIter2 __copy_backward(_BidirectionalIter1 __first, _BidirectionalIter1 __last, _BidirectionalIter1 __result,
	...
	struct __copy_backward_dispatch {
		...
		static _BidirectionalIter2
			copy(_BidirectionalIter1 __first, _BidirectionalIter1 __last, _BidirectionalIter1 __result) {
	...
	struct __copy_backward_dispatch<_Tp*, _Tp*, __true_type> {
		static _Tp* copy(const _Tp* __first, const _Tp* __last, _Tp* __result) {
			...
			memmove(__result - _Num, __first, sizeof(_Tp) * Num);//memmove其实就算复制函数
	...
	inline _BI2 __copy_backward(_BI1 __first, _BI1 __last, _BI2 __result) {
	...
	template<class _Tp>
	inline _Tp* __copy_aux2(const _Tp* __fist, const _Tp* __last, _Tp* __result, __true_type) {
	...
	inline void __iter_swap(_ForwardIter1 __a, _ForwardIter1 __b, _Tp*) {
		_Tp _tmp = *__a;
		*__a = *__b;
		*__b = _tmp;
	}
	...
	inline void __iter_swap(_ForwardIter1 __a, _ForwardIter1 __b) {
	...
	inline bool equal(_InputIter1 __first1, _InputIter1 __last1, _InputIter2 __first2, _InputIter __last2,
		_BinaryPredicate __binary_pred) {
		for (;__first1 != __last1;++first1, ++first2) 
	...
	inline bool lexicographical_compare(const unsigned char* __first1, const unsigned char* __last1, const unsigned char* __first2,
		const unsigned char* __last2) {
		const size_t __len1 = __last1 - __first1;
		const size_t __len2 = __last2 - __first2;
		const int __result = memcmp(__first1, __frist2, min(__len1, __len2));//比较函数，比较的长度为短的那个,返回值bool值取决与前者	
