...
_STL_BEGIN_NAMESPACE
	...
	struct input_iterator {
		...
		typedef	_Distance difference_type; //大小或距离
		typedef _Tp* pointer; //定义指针
		typedef _Tp& reference; //定义引用
	};
...
#define __VALUE_TYPE(__i) __value_type(__i)
	...
	inline typename iterator_traits<_InputIterator>::difference_type
		__distance(_InputIterator __first, _InputItetator __last, input_iterator_tag) {
	...
	template<class _BidirectionalIterator,class _Distance> //指定指针移动指定距离
